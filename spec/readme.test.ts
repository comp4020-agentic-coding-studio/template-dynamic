...
// README.md to text as GitHub-flavoured markdown and asserts the served page
// contains all of it: styling, navigation and a footer around it pass; a
// trimmed or paraphrased copy fails.
...
describe("readme", () => {
  it("serves the whole of README.md at /readme/", async () => {
    const expected = normalise(text(await marked.parse(readFileSync("README.md", "utf8"))));
